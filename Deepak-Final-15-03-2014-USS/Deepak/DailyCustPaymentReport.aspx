<%@ page language="C#" masterpagefile="~/AppMaster.master" autoeventwireup="true" inherits="DailyCustPaymentReport, App_Web_utcvgpzk" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <div id="Page">
        <div style="display: block" id="Block_MainPage" runat="server">
            <div class="three-col-new">
                ...
                <div class="ControlsWrapper1">
                    <div>
                        <asp:RadioButtonList ID="rdSelect" runat="server" RepeatDirection="Horizontal" Width="100%"
                            AutoPostBack="true" OnSelectedIndexChanged="rdSelect_SelectedIndexChanged">
                            <asp:ListItem Value="0">CollectedBy</asp:ListItem>
                            <asp:ListItem Value="1">Day Wise</asp:ListItem>
                            <%--<asp:ListItem Value="2">Month Wise</asp:ListItem>--%>
                        </asp:RadioButtonList>
                    </div>
                    <div>
                        <asp:Label ID="lblCollectedBy" runat="server" Text="CollectedBy"></asp:Label>
                        <asp:DropDownList ID="ddlCollectedBy" TabIndex="3" runat="server" AutoPostBack="true">
                            <asp:ListItem Value="0">--SELECT--</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                 <%--   <div>
                        <asp:Label ID="lblFromDate" runat="server" Text="FromDate"  Visible="false" ></asp:Label>
        ...
        <div>
                <a href="DailyCustPaymentReport.aspx">
