<%@ page language="C#" masterpagefile="~/AppMaster.master" autoeventwireup="true" inherits="LorryAcSlipReport, App_Web_utcvgpzk" title="Chennai" %>
                        ...
                        <div class="ControlsWrapper1">
                            ...
                            <div>
                                ...
                                <asp:DropDownList ID="ddlType" runat="server" OnSelectedIndexChanged="ddlType_SelectedIndexChanged"
                                    ...
                                    <asp:ListItem Value="1">LSlipNo Wise</asp:ListItem>
