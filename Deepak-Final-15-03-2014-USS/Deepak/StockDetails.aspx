<%@ page language="C#" masterpagefile="~/AppMaster.master" autoeventwireup="true" inherits="StockDetails, App_Web_utcvgpzk" title="Deepak Roadways" %>
                ...
                <div class="single-col">
                    ...
                    <div class="ControlsWrapper1">
                        <div>
                            ...
                            <asp:TextBox ID="txtToDate" MaxLength="10" runat="server" AutoPostBack="true" OnTextChanged="txtToDate_TextChanged"></asp:TextBox>
