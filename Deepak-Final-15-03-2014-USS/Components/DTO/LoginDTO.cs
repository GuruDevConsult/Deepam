...
namespace Components.DTO
{
    public class LoginDTO
    {
        ...
        public string BranchN
        {
            get
            {
                return Convert.ToString(HttpContext.Current.Session["_BranchName"]);
                //return _BranchName; 
            }
            set
            {
                System.Web.HttpContext.Current.Session["_BranchName"] = value;
                //_BranchName = value; 
            }
        }
        #endregion
        ...
        public string UserName
        {
            ...
            {
                //return _UserName; 
                return Convert.ToString(HttpContext.Current.Session["_UserName"]);
            }
            set
            {
                //_UserName = value; 
        ...
        public string Password
        {
            ...
            {
                //return _Password; 
                return Convert.ToString(HttpContext.Current.Session["_Password"]);
            }
            set
            {
                //_Password = value; 
                System.Web.HttpContext.Current.Session["_Password"] = value;
            }
        }
        #endregion
        ...
        public static string UserID
        {
            ...
            {
                //return _UserID; 
                return Convert.ToString(HttpContext.Current.Session["_UserID"]);
            }
            set
            {
                //_UserID = value; 
                System.Web.HttpContext.Current.Session["_UserID"] = value;
            }
        }
        #endregion
